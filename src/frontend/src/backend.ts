...
export class Backend implements backendInterface {
    ...
    async createCustomer(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createInvoice(arg0: string, arg1: Array<InvoiceItem>, arg2: bigint, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createProduct(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateCustomer(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
